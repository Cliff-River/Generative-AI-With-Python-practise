...
classifier = pipeline("zero-shot-classification", odel="facebook/bart-large-mnli")
candidate_labels = [ "romance", "crime", "fantasy" ]
...
pos = 0
df = pd.DataFrame(results[pos])

# %%
df.plot.bar(x="labels", y="scores", title=titles[pos])
